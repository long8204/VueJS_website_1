<template>
  <div id="wrapper" :style="{ width: width, height: height }">
    <section class="slideshow" id="js-header">
      <div v-for="(image, index) in images" :key="index" class="slideshow__slide js-slider-home-slide"
        :data-slide="index + 1">
              ...
              <div class="slideshow__slide-background-wrap background-absolute">
                <div class="slideshow__slide-background background-absolute">
                  <div class="slideshow__slide-image-wrap background-absolute">
                    <div class="slideshow__slide-image background-absolute" :style="getImageStyle(image)">
                    </div>
                  </div>
                </div>
              </div>
...
export default {
  ...
  methods: {
    getImageStyle(image) {
      // Return the style object with the dynamic background-image property
      return {
